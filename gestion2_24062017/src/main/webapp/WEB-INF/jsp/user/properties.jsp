										...
										<div class="col-lg-12">
											...
											<div class="col-md-6">
												<div class="form-group">
													<label for="txt_firstname" class="small">First Name<span
														class="obligatoire" style="color: red">*</span></label>
											...
											<div class="col-md-6">
												<div class="form-group">
													<label for="txt_lastname" class="small">Last Name<span
											...
											<div class="col-md-6">
												<div class="form-group">
													<label for="txt_password" class="small">Password<span
														class="obligatoire" style="color: red">*</span></label> <input
