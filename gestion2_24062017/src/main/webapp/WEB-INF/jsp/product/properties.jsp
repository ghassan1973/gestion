							...
							<form:form role="form" method="POST" modelAttribute="product"
										...
										<div class="col-lg-12">
											<div class="col-md-6">
												<div class="form-group">
													<label for="txt_productname" class="small"> Name <span
														class="obligatoire" style="color: red">*</span></label> <input
														type="text" name="ProductName" class="form-control"
														id="product_name_input" placeholder="Enter ProductName"
														value="${product.productName}" autofocus required />
												</div>
											</div>
								...
								<div class="box-footer col-md-12 pull-right">
									...
									<button type="submit" class="btn btn-primary"
										id="save_product_btn">Apply</button>
								</div>
							</form:form>
						</div>
					</div>
