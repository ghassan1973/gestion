					...
					<div class="row">
						<div class="col-lg-12 header-bar">
							<ol class="breadcrumb">
								...
								<li class="active"><span>Project Type</span></li>
							</ol>
						</div>
					</div>
					<div class="main-box">
							...
							<div class="form-group">
								<div class="clearfix">
									<div class="col-lg-3 padding-b-15">
										<label class="small" for="ProjectTypeName">Name</label> <input
											id="project_type_name" type="text" class="form-control"
											placeholder="Name" name="projectTypeName"
											value="${search.projectTypeName}" />
									</div>
								</div>
								<div class="col-lg-12">
							...
							<table id="mytable"
								...
								<thead>
									<tr>
										...
										<th colspan=2><a
											href="${pageContext.request.contextPath}/projectType/create"
