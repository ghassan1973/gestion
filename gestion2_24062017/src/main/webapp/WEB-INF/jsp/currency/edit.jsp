					...
					<div class="main-box">
						<div class="row">
							<form role="form" method="POST"
								action="${pageContext.request.contextPath}/currency/createCurrency"
										...
										<div class="col-lg-12">
											...
											<div class="form-group">
												<label for="txt_currencyname" class="small">Currency
													Name</label> <input type="text" placeholder="Currency Name"
													class="form-control" id="txt_currencyname"
													name="CurrencyName" value="${model.currencyName}">
											</div>
								...
								<div class="box-footer col-md-12 pull-right">
									<a type="submit" class="btn btn-info"
										href="<?= $GLOBALS['context'] ?>/currency">Cancel</a>
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="box box-primary">
								...
								<!-- form start -->
								<form role="form" method="POST"
									action="<%=request.getContextPath()%>/app/currency/save">
									<div class="box-body">
										<div class="form-group">
											<label for="txt_currencyid">CurrencyId</label> <input
												type="text" name="CurrencyId" class="form-control"
												id="txt_currencyid" placeholder="Enter CurrencyId"
												value="${d}{model.currencyId}">
										</div>
										<div class="form-group">
											<label for="txt_currencyname">CurrencyName</label> <input
												type="text" name="CurrencyName" class="form-control"
												id="txt_currencyname" placeholder="Enter CurrencyName"
												value="${d}{model.currencyName}">
										</div>
										<div class="form-group">
									...
									<div class="box-footer">
										<a type="submit" class="btn btn-info"
											href="<%=request.getContextPath()%>/app/currency">Cancel</a>
										<button type="submit" class="btn btn-primary">Submit</button>
									</div>
								</form>
							</div>
