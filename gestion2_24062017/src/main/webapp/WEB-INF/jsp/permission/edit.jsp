					...
					<div class="main-box">
						<div class="row">
							<form role="form" method="POST"
								action="${pageContext.request.contextPath}/permission/createPermission"
								...
								<div class="box-footer col-md-12 pull-right">
									<a type="submit" class="btn btn-info"
										href="<?= $GLOBALS['context'] ?>/Permission">Cancel</a>
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="box box-primary">
								...
								<!-- form start -->
								<form role="form" method="POST"
									action="<%=request.getContextPath()%>/app/permission/save">
									<div class="box-body">
										<div class="form-group">
									...
									<div class="box-footer">
										<a type="submit" class="btn btn-info"
											href="<%=request.getContextPath()%>/app/permission">Cancel</a>
										<button type="submit" class="btn btn-primary">Submit</button>
									</div>
								</form>
							</div>
