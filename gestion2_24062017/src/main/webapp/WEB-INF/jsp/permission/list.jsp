				...
				<div class="col-xs-12 col-sm-8 col-md-9 col-lg-12">
					...
					<div class="main-box">
						<form class="form-horizontal"
							action="${pageContext.request.contextPath}/permission/search"
							method="post">
							<div class="form-group">
								<div class="clearfix">
									<div class="col-lg-3 padding-b-15">
										<label class="small" for="PermissionName">Name</label> <input
											id="permission_name" type="text" class="form-control"
											placeholder="Name" name="permissionName"
							...
							<table id="mytable"
								...
								<thead>
									<tr>
										...
										<th colspan=2><a
											href="${pageContext.request.contextPath}/permission/create"
										...
										<tr class=" repeated">
											...
											<td colspan=2 align="right">
												<p data-placement="top" data-toggle="tooltip" title="Edit">
													<a class="btn btn-success btn-xs edit_permission_link"
														href="${pageContext.request.contextPath}/permission/${item.permissionId}/edit"><span
														class="glyphicon glyphicon-pencil"></span>&nbsp;</a>
													<a
														class="btn btn-danger btn-xs delete_order_link delete_link"
														data-title="Delete"
														href="${pageContext.request.contextPath}/permission/${item.permissionId}/delete"><span
