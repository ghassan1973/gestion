							...
							<form:form role="form" method="POST" modelAttribute="permission"
										...
										<div class="col-lg-12">
											<div class="col-md-6">
												<div class="form-group">
													<label for="txt_familytiername" class="small">Name <span
														class="obligatoire" style="color: red">*</span></label> <input type="text" name="PermissionName"
														class="form-control" id="permission_name_input"
														placeholder="Enter Name"
														value="${permission.permissionName}" autofocus required/>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="box-footer col-md-12 pull-right">
									...
									<button type="submit" class="btn btn-primary"
										id="save_permission_btn">Apply</button>
								</div>
							</form:form>
						</div>
					</div>
