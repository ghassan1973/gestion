					...
					<div class="row">
						<div class="col-lg-12 header-bar">
							<ol class="breadcrumb">
								...
								<li><a href="${pageContext.request.contextPath}/region">Region</a></li>
								<li class="active"><span>Create Region</span></li>
							</ol>
							<h3>Create Region</h3>
						</div>
					</div>
					<div class="main-box">
						<div class="row">
							<form role="form" method="POST"
								action="${pageContext.request.contextPath}/region/createRegion"
									...
									<div class="row">
										<div class="col-lg-12">
											...
											<div class="form-group">
												<label for="txt_regionname" class="small">Region
													Name</label> <input type="text" placeholder="Region Name"
													class="form-control" id="txt_regionname" name="RegionName"
								...
								<div class="box-footer col-md-12 pull-right">
									<a type="submit" class="btn btn-info"
										href="<?= $GLOBALS['context'] ?>/Region">Cancel</a>
									<button type="submit" class="btn btn-primary"
										id="save_region_btn">Submit</button>
								</div>
							</form>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="box box-primary">
								...
								<!-- form start -->
								<form role="form" method="POST"
									action="<%=request.getContextPath()%>/app/region/save">
									<div class="box-body">
										<div class="form-group">
											<label for="txt_regionid">RegionId</label> <input type="text"
												name="RegionId" class="form-control" id="txt_regionid"
												placeholder="Enter RegionId" value="${d}{model.regionId}">
										</div>
										<div class="form-group">
											<label for="txt_regionname">RegionName</label> <input
												type="text" name="RegionName" class="form-control"
												id="txt_regionname" placeholder="Enter RegionName"
												value="${d}{model.regionName}">
										</div>
										<div class="form-group">
									...
									<div class="box-footer">
										<a type="submit" class="btn btn-info"
											href="<%=request.getContextPath()%>/app/region">Cancel</a>
										<button type="submit" class="btn btn-primary">Submit</button>
									</div>
								</form>
							</div>
