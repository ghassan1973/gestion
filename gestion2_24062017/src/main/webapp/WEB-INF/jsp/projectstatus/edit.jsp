					...
					<div class="main-box">
						<div class="row">
							<form role="form" method="POST"
								action="${pageContext.request.contextPath}/projectStatus/createProjectStatus"
										...
										<div class="col-lg-12">
											...
											<div class="form-group">
												<label for="txt_projectstatusname" class="small">Project
													Status Name</label> <input type="text"
													placeholder="Project Status Name" class="form-control"
													id="txt_projectstatusname" name="ProjectStatusName"
													value="${model.projectStatusName}">
											</div>
								...
								<div class="box-footer col-md-12 pull-right">
									<a type="submit" class="btn btn-info"
										href="<?= $GLOBALS['context'] ?>/ProjectStatus">Cancel</a>
...
<body class="skin-blue">
	<div class="wrapper">
		...
		<div class="content-wrapper" style="min-height: 916px;">
			<!-- Content Header (Page header) -->
			<section class="content-header">
				<h1>ProjectStatuss</h1>
				<ol class="breadcrumb">
					<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
					<li class="active">ProjectStatus List</li>
				</ol>
				<!-- Content Wrapper. Contains page content -->
				<!-- Main content -->
				<section class="content">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="box box-primary">
								<div class="box-header with-border">
									<h3 class="box-title">Edit ProjectStatus</h3>
								</div>
								<!-- /.box-header -->
								<!-- form start -->
								<form role="form" method="POST"
									action="<%=request.getContextPath()%>/app/projectStatus/save">
									<div class="box-body">
										<div class="form-group">
											<label for="txt_projectstatusid">ProjectStatusId</label> <input
												type="text" name="ProjectStatusId" class="form-control"
												id="txt_projectstatusid" placeholder="Enter ProjectStatusId"
												value="${d}{model.projectStatusId}">
										</div>
										<div class="form-group">
											<label for="txt_projectstatusname">ProjectStatusName</label>
											<input type="text" name="ProjectStatusName"
												class="form-control" id="txt_projectstatusname"
												placeholder="Enter ProjectStatusName"
												value="${d}{model.projectStatusName}">
										</div>
										<div class="form-group">
									...
									<div class="box-footer">
										<a type="submit" class="btn btn-info"
											href="<%=request.getContextPath()%>/app/projectStatus">Cancel</a>
										<button type="submit" class="btn btn-primary">Submit</button>
									</div>
								</form>
							</div>
