										...
										<div class="col-lg-12">
											...
											<div class="col-md-6">
												<div class="form-group">
													<label for="txt_rolename" class="small">Name <span
														class="obligatoire" style="color: red">*</span></label> <input
														type="text" name="RoleName" class="form-control"
														id="role_name_input" placeholder="Enter Name"
														value="${role.roleName}" autofocus required/>
												</div>
											</div>
