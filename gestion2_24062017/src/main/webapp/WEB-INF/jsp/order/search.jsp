					...
					<li class="panel-group" id="accordion">
						<ul class="panel panel-default" style="background: none;">
							<li><label class="small" for="OrderName"
								style="color: white;">Name</label> <input id="order_name"
