					...
					<div class="main-box">
						<div class="row">
							<form role="form" method="POST"
								action="${pageContext.request.contextPath}/familyTier/createFamilyTier"
										...
										<div class="col-lg-12">
											...
											<div class="form-group">
												<label for="txt_familytiername" class="small">Family
													Tier Name</label> <input type="text" placeholder="Family Tier Name"
													class="form-control" id="txt_familytiername"
													name="FamilyTierName" value="${model.familyTierName}">
											</div>
								...
								<div class="box-footer col-md-12 pull-right">
									<a type="submit" class="btn btn-info"
										href="<?= $GLOBALS['context'] ?>/familyTier">Cancel</a>
	...
	<div class="wrapper">
		...
		<div class="content-wrapper" style="min-height: 916px;">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
					<li class="active">FamilyTier List</li>
				</ol>
				<!-- Content Wrapper. Contains page content -->
				<!-- Main content -->
				<section class="content">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="box box-primary">
								<div class="box-header with-border">
									<h3 class="box-title">Edit FamilyTier</h3>
								</div>
								<!-- /.box-header -->
								<!-- form start -->
								<form role="form" method="POST"
									action="<%=request.getContextPath()%>/app/familyTier/save">
									<div class="box-body">
										<div class="form-group">
											<label for="txt_familytierid">FamilyTierId</label> <input
												type="text" name="FamilyTierId" class="form-control"
												id="txt_familytierid" placeholder="Enter FamilyTierId"
												value="${d}{model.familyTierId}">
										</div>
										<div class="form-group">
											<label for="txt_familytiername">FamilyTierName</label> <input
												type="text" name="FamilyTierName" class="form-control"
												id="txt_familytiername" placeholder="Enter FamilyTierName"
												value="${d}{model.familyTierName}">
										</div>
										<div class="form-group">
									...
									<div class="box-footer">
										<a type="submit" class="btn btn-info"
											href="<%=request.getContextPath()%>/app/familyTier">Cancel</a>
										<button type="submit" class="btn btn-primary">Submit</button>
									</div>
								</form>
							</div>
