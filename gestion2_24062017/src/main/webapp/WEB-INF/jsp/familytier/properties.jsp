							...
							<form:form role="form" method="POST" modelAttribute="familyTier"
											...
											<div class="col-md-6">
												<div class="form-group">
													<label for="txt_familytiername" class="small">Name <span
														class="obligatoire" style="color: red">*</span></label> <input type="text" name="FamilyTierName"
														class="form-control" id="family_tier_name_input"
														placeholder="Enter Name"
														value="${familyTier.familyTierName}" autofocus required/>
												</div>
											</div>
								...
								<div class="box-footer col-md-12 pull-right">
									...
									<button type="submit" class="btn btn-primary"
										id="save_familyTier_btn">Apply</button>
								</div>
							</form:form>
						</div>
					</div>
