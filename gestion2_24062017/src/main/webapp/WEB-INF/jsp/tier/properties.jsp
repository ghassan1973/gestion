										...
										<div class="col-lg-12">
											...
											<div class="col-md-6">
												<div class="form-group">
													<label for="txt_tiername" class="small">Name <span
														class="obligatoire" style="color: red">*</span></label> <input
														type="text" name="TierName" class="form-control"
														id="tier_name_input" placeholder="Enter Name"
														value="${tier.tierName}" autofocus required />
												</div>
											</div>

											<div class="col-md-6">
												<div class="form-group" id="type_dropdown_parent">
													<label for="sel_type" class="small">FamilyT ier</label> <select
											...
											<div class="col-lg-12">
												...
												<div class="col-md-6">
													<div class="form-group">
														<label for="txt_address1" class="small">Address_1</label>
												...
												<div class="col-md-6">
													<div class="form-group">
														<label for="txt_address2" class="small">Address_2</label>
